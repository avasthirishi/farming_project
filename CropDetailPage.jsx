...
//         {crop.image && (
//           <div className="flex justify-center items-center p-4 bg-green-50 rounded-lg shadow-inner">
//             <img src={crop.image} alt={crop.name} className="max-h-96 w-full object-contain rounded-lg" />
//           </div>
//         )}
